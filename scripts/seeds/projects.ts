...
const projectsRaw = [
  {
    ...
    description: 'A social media platform for devs to share projects and ideas.',
    username: 'testuser1',
  ...
  },
  {
    ...
    description: 'A modern, animated developer portfolio with filtering and tags.',
    username: 'testuser2',
    visibility: 'public',
...
export async function seedProjects() {
  ...
  const projects = projectsRaw.map((entry) => {
