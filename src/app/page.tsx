  ...
  return (
    <section className='px-4 md:px-10 py-20 w-full h-full min-h-screen relative bg-primary-950/30'>
      ...
      <div className='relative pt-[20vh] h-full bg-cover bg-center flex flex-col items-center justify-center pb-8 gap-20'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 w-full lg:w-2/3 gap-x-8 xl:gap-x-20 gap-y-8 text-text-300'>
          <div className='flex flex-col text-center border-2 border-secondary-700 p-4 flex-1 bg-secondary-950/50'>
            <p className='font-bold text-xl'>1</p>
            <p className='font-bold text-xl'>Create a build log</p>
            <p>Start sharing your project</p>
          </div>
          <div className='flex flex-col text-center border-2 border-primary-700 p-4 flex-1 bg-primary-950/50'>
            <p className='font-bold text-xl'>2</p>
            <p className='font-bold text-xl'>Engage</p>
            <p>Get feedback, give feedback</p>
          </div>
          <div className='flex flex-col text-center border-2 border-accent-700 p-4 flex-1 bg-accent-950/50'>
