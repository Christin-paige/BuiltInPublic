...
const Home: FC = () => {
  return (
    <section className='px-4 md:px-10 pt-24 sm:pt-36 xl:pt-54 gap-16 w-full min-h-screen relative bg-primary-950/30 flex flex-col items-center'>
      ...
      <div className='absolute top-[15%] md:top-[20%] lg:top-[20%] left-[-10] md:left-[25%] xl:left-[30%] w-full md:w-1/2 xl:w-2/5 h-1/5 lg:h-1/4 xl:h-1/3 rounded-full bg-radial from-pink-500/60 to-indigo-600/60 blur-3xl z-0'></div>
