...
import AnimatedBlobs from './components/AnimatedBlobs'; // make sure this points to your AnimatedBlobs component

const Home: FC = () => {
  return (
    <div className='px-4 pb-8 md:px-10 pt-24 sm:pt-36 xl:pt-54 gap-16 xl:gap-20 w-full min-h-[auto] relative bg-primary-950/30 flex flex-col items-center md:min-h-[120vh'>
      {/* Floating animated blobs */}
      <div className='absolute inset-0 w-full pointer-events-none'>
        <AnimatedBlobs numBlobs={6} className='w-full relative' />
      </div>
