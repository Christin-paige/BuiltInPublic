...
export default async function Onboarding() {
  return (
    <main className='flex items-center justify-center w-full h-screen md:px-4 bg-primary-950/30 relative'>
      ...
      <div className='flex flex-col md:flex-row w-full md:w-fit mx-auto px-4 md:px-8 text-center rounded-md md:border py-8 gap-8 z-10 backdrop-blur-3xl
        ...
        <header className='flex flex-col gap-2'>
          <h1 className='text-3xl md:text-4xl lg:text-5xl text-text-100 font-bold font-subheading'>Welcome!</h1>
          <p className='text-text-200 max-w-md md:text-lg lg:text-xl font-body'>
