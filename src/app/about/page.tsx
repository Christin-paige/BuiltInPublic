    ...
    <div className="flex flex-col items-center justify-center pt-45 min-h-screen bg-gradient-to-b from-[#1d1d1d] to-[#86059F] p-8 text-white">
      ...
      <section className="w-full max-w-4xl space-y-8">
        ...
        <div>
          ...
          <p>
            {`I created CodeSphere because I know how isolating coding can
            feel—especially when you're just getting started or making a career
            switch. I wanted to create a space where developers can come
            together, share their progress, and support each other.`}
          </p>
        </div>
